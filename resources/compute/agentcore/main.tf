...
resource "aws_bedrockagentcore_agent_runtime" "agentcore" {
  agent_runtime_name = var.env == "prod" ? "car-agent-agentcore-runtime-prod" : "car-agent-agentcore-runtime-dev"
...
resource "aws_bedrockagentcore_agent_runtime_endpoint" "agentcore" {
  name             = var.env == "prod" ? "car-agent-agentcore-endpoint-prod" : "car-agent-agentcore-endpoint-dev"
